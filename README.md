## Akash Sample Procj -> Jenkins Pipeline for Python Build and Test Stages
...
* The link to the public Github file that consist of groovy script for the pipelies: https://github.com/akash-p-07/Python-Build-Test-Procj/blob/main/Jenkinsfile
